...
class Naskar2021(LinearCouplingModel):
    ...
    t_glu = Attr(default=7.46, attr_type=AttrType.Model)
    t_gaba = Attr(default=1.82, attr_type=AttrType.Model)
    We = Attr(default=1.0, attr_type=AttrType.Model)
    Wi = Attr(default=0.7, attr_type=AttrType.Model)
    ...
    alfa_e = Attr(default=0.072, attr_type=AttrType.Model)
    alfa_i = Attr(default=0.53, attr_type=AttrType.Model)
    B_e = Attr(default=0.0066, attr_type=AttrType.Model)
    B_i = Attr(default=0.18, attr_type=AttrType.Model)
    gamma = Attr(default=1.0, attr_type=AttrType.Model)
    rho = Attr(default=3.0, attr_type=AttrType.Model)
